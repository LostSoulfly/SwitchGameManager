...
namespace XCI_Explorer
{
    public class MainForm : Form
    {
        ...
        public double exactUsedSpace;
        public double exactSize;

        public Image[] Icons = new Image[16];
        ...
        public TextBox TB_ROMExactSize;
        ...
        public void B_TrimXCI_Click(object sender, EventArgs e)
        {
            if (Util.checkFile(TB_File.Text))
            {
