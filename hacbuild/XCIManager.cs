...
namespace hacbuild
{
    public static class XCIManager
    {
        ...
        public const UInt64 HFS0_START = 0xf000;                  // Offset (in bytes) for /root.hfs0 in a xci file
        ...
        public const int XCI_GAMECARD_INFO_PADDING_LENGTH = 0x38; // Length of the empty data at the end of GameInfo

        // Decryption key of GameInfo 
        // Google it : "XCI Header Key"
        public static byte[] XCI_GAMECARDINFO_KEY = new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };

        // THIS IS NOT THE KEY, JUST A SHA256 HASH TO CHECK THE VALIDITY
        public static byte[] XCI_GAMECARD_KEY_SHA256 = new byte[] { 0x2E, 0x36, 0xCC, 0x55, 0x15, 0x7A, 0x35, 0x10, 0x90, 0xA7, 0x3E, 0x7A, 0xE7, 0x7C, 0xF5, 0x81, 0xF6, 0x9B, 0x0B, 0x6E, 0x48, 0xFB, 0x06, 0x6C, 0x98, 0x48, 0x79, 0xA6, 0xED, 0x7D, 0x2E, 0x96 };
        ...
        public struct gamecard_info
        {
            public UInt64 Version;
            public UInt32 AccessControlFlags;
            public UInt32 ReadWaitTime;
            public UInt32 ReadWaitTime2;
            public UInt32 WriteWriteTime;
            public UInt32 WriteWriteTime2;
            public UInt32 FirmwareMode;
            public UInt32 CUPVersion;
            public UInt32 UnkEmpty;
            public UInt64 UpdatePartitionHash;
            public UInt64 CUPID;
